...
import Pipeline.Core.Task (TaskF, functionTaskF)
...
add00Task :: (TaskF :<: iF) => IFix2 iF '[IOStore String] '[VariableStore String]
add00Task = functionTaskF (++ ("00" :: String)) Empty

readTask :: (TaskF :<: iF) => IFix2 iF '[VariableStore String] '[VariableStore Int]
readTask = functionTaskF (read :: String -> Int) Empty

showTask :: (TaskF :<: iF) => IFix2 iF '[VariableStore Int] '[IOStore String]
showTask = functionTaskF (show :: Int -> String) IOEmpty
