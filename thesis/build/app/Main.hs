...
buildDissPipeline :: Circuit '[FileStore] '[String] '[FileStore String] '[FileStore] '[String] '[FileStore String] N1
buildDissPipeline = lhs2TexTask
                    <->
                    buildTexTask

lhs2TexTask :: Circuit '[FileStore] '[String] '[FileStore String] '[FileStore] '[String] '[FileStore String] N1
