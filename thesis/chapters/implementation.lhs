...
The later more interesting case deals with a cons in the type lists. Here a new channel is created with the same type as the type removed from the front of the type list. The channel is then consed to the front of a |PipeList| with the remaining list generated by a recursive call.
