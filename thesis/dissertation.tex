...
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Conid{Nil}{}\<[9]%
\>[9]{}\mathbin{::}\Conid{Vec}\codeskip \Varid{a}\codeskip Zero{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Conid{Cons}{}\<[9]%
\>[9]{}\mathbin{::}\Varid{a}\to \Conid{Vec}\codeskip \Varid{a}\codeskip \Varid{n}\to \Conid{Vec}\codeskip \Varid{a}\codeskip (Succ\codeskip \Varid{n}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{safeHead}\mathbin{::}\Conid{Vector}\codeskip (Succ\codeskip \Varid{n})\codeskip \Varid{a}\to \Varid{a}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Conid{SZero}\mathbin{::}\Conid{SNat}\codeskip Zero{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Conid{SSucc}\mathbin{::}\Conid{SNat}\codeskip \Varid{n}\to \Conid{SNat}\codeskip (Succ\codeskip \Varid{n}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[3]{}\Varid{a}{}\<[6]%
\>[6]{}\mathbin{:+}{}\<[6E]%
\>[10]{}Succ\codeskip \Varid{b}{}\<[18]%
\>[18]{}\mathrel{=}{}\<[18E]%
\>[21]{}Succ\codeskip (\Varid{a}\mathbin{:+}\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
