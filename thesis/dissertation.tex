...
When constructors are promoted to type constructors, they are prefixed with a '~\todo{I cannot get this to work in lhs2tex :(}. For example \ensuremath{\Conid{Zero}}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{safeHead}\mathbin{::}\Conid{Vector}\codeskip (\Conid{Succ}\codeskip \Varid{n})\codeskip \Varid{a}\to \Varid{a}{}\<[E]%
\\
...
\>[3]{}\Varid{a}{}\<[6]%
\>[6]{}\mathbin{:+}{}\<[6E]%
\>[10]{}\Conid{Succ}\codeskip \Varid{b}{}\<[18]%
\>[18]{}\mathrel{=}{}\<[18E]%
\>[21]{}\Conid{Succ}\codeskip (\Varid{a}\mathbin{:+}\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
