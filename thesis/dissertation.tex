...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{data}\codeskip (\Varid{f}:\!\!+\!\!:\Varid{g})\codeskip \Varid{e}\mathrel{=}\Conid{L}\codeskip (\Varid{f}\codeskip \Varid{e})\mid \Conid{R}\codeskip (\Varid{g}\codeskip \Varid{e}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
