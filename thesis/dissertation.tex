...
\\
\>[B]{}\mathbf{module}\codeskip \Conid{Dissertation}\codeskip \mathbf{where}{}\<[E]%
\\
...
\noindent
The resulting type of \ensuremath{\Varid{icata}} is \ensuremath{\Varid{f}\codeskip \Varid{a}}\todo{but uses \ensuremath{\leadsto} so is actually f! might be confusing}, this requires the \ensuremath{\Varid{f}} to be a \ensuremath{\Conid{Functor}}.
\todo{explain that \ensuremath{\Conid{IFix}\codeskip \Conid{ParserF}} is a functor.}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{data}\codeskip \Conid{ValF}\codeskip \Varid{f}\mathrel{=}\Conid{ValF}\codeskip \Conid{Int}{}\<[E]%
\\
\>[B]{}\mathbf{data}\codeskip \Conid{MulF}\codeskip \Varid{f}\mathrel{=}\Conid{MulF}\codeskip \Varid{f}\codeskip \Varid{f}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{exampleExpr}\mathbin{::}\Conid{Fix}\codeskip (\Conid{ValF}:\!\!+\!\!:\Conid{MulF}){}\<[E]%
\\
\>[B]{}\Varid{exampleExpr}\mathrel{=}\Conid{In}\codeskip (\Conid{R}\codeskip (\Conid{MulF}\codeskip (\Conid{In}\codeskip (\Conid{L}\codeskip (\Conid{ValF}\codeskip \mathrm{12})))\codeskip (\Conid{In}\codeskip (\Conid{L}\codeskip (\Conid{ValF}\codeskip \mathrm{34}))))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{val}\mathbin{::}(\Conid{ValF}:\prec:\Varid{f})\Rightarrow \Conid{Int}\to \Conid{Fix}\codeskip \Varid{f}{}\<[E]%
\\
\>[B]{}\Varid{val}\codeskip \Varid{x}\mathrel{=}\Varid{inject}\codeskip (\Conid{ValF}\codeskip \Varid{x}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}(\mathbin{*})\mathbin{::}(\Conid{MulF}:\prec:\Varid{f})\Rightarrow \Conid{Fix}\codeskip \Varid{f}\to \Conid{Fix}\codeskip \Varid{f}\to \Conid{Fix}\codeskip \Varid{f}{}\<[E]%
\\
\>[B]{}\Varid{x}\mathbin{*}\Varid{y}\mathrel{=}\Varid{inject}\codeskip (\Conid{MulF}\codeskip \Varid{x}\codeskip \Varid{y}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
